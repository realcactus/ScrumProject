 ...
 * @author OovEver
 */
public class updateCoursePictureFB extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet updateCoursePictureFB</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet updateCoursePictureFB at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        session.setAttribute("url3", urlString);
          ...
          response.sendRedirect("/Discuz/User/Account/courseFBEditDetail.jsp?id="+id+"");
        processRequest(request, response);
    }
