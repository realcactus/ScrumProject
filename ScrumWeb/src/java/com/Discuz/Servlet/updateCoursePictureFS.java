 ...
 * @author OovEver
 */
public class updateCoursePictureFS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet updateCoursePictureFS</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet updateCoursePictureFS at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        session.setAttribute("url3", urlString);
          ...
          response.sendRedirect("/Discuz/User/Account/courseFSEditDetail.jsp?id="+id+"");
        processRequest(request, response);
    }
