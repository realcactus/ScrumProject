...
<form action="../../addCommentServlet" method="post">
    <table width="100%" cellpadding="0" cellspacing="0">
         <% 
                                    ...
                                    List<Comment> list=CommentManagerDao.getInstance().selectCommentInfo2(school, academy, course);
          ...
          <tr>
            ...
            <td ><%=pu.getComment()%></td>
                ...
                <tr>
                    ...
                    <td align="right">
                        <a href="/Discuz/User/StudentInfor/showComment.jsp">全部问答</a>
                    </td>
                </tr>
                 <tr>
            <td width="15%" align="right"><div align="right">评论内容： </div></td>
            <td><textarea name="Ccontent" cols="80" rows="5" id="Ccontent" class="input_2"></textarea></td>
        </tr>
        <tr>
            <td colspan="2" align="center">
                <div align="center" >
                    <input type="submit" value="发表问答" onclick="saveClick('7c50f70a-775b-4aef-8bf2-5010ec612c0d')" class="input2" />
