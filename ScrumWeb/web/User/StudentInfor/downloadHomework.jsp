<%-- 
    Document   : downloadHomework
    Created on : 2015-10-8, 0:02:24
    Author     : OovEver
--%>
    ...
    <%
       ...
       Connection conn = DBcon.getConn();
        int id=0;
         ...
         String user="";
         int groupNum=0;
       String sql="select * from  db_StudentMS.dbo.\"work\"";
...
%>  
    ...
    <a href = "/StudentManageSystem/User/StudentInfor/showHomeworkTest.jsp?curPage=1" >首页</a>  
<a href = "/StudentManageSystem/User/StudentInfor/showHomeworkTest.jsp?curPage=<%=curPage-1%>" >上一页</a>  
<a href = "/StudentManageSystem/User/StudentInfor/showHomeworkTest.jsp?curPage=<%=curPage+1%>" >下一页</a>  
<a href = "/StudentManageSystem/User/StudentInfor/showHomeworkTest.jsp?curPage=<%=pageCount%>" >尾页</a> 
<%
if(curPage<0)
{
    curPage=0;
