<%-- 
    Document   : showAllFile
    Created on : 2015-12-23, 12:32:46
    Author     : OovEver
--%>
...
<div class="morebt">
    <%
                                    int numI=FileManagerDao.getInstance().selectFileNum();
    %>
  <div class="searchBox" align="center">
    <form action="/Discuz/User/StudentInfor/Search.jsp">
				<input type="text" class="searchIpt f14" name="keyword" maxlength="100" autocomplete="off" style="width:311px;height:21px"/>
                                <input type="submit" class="btn cp" value="资源检索" />共有资源<font color="red"><%=numI%></font>条
			</form>
    </div>      
...
<div class="cztable">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        List<SubmitFile> list = FileManagerDao.getInstance().selectEditCourseInfo();
