<%-- 
    Document   : showSchoolFAC
    Created on : 2015-12-2, 14:44:21
    Author     : OovEver
--%>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr style="height: 28px" class="tdbg" align="center">
           <tr style="height: 28px" class="tdbg" align="center">
            ...
            <td width="33%" align="center" style="color: Red; font-weight:bold;"><a href="/Discuz/User/StudentInfor/showAcademyFAC.jsp?school=<%=schoolNameString[j]%>"><%=schoolNameString[j]%></a></td>
            <td width="33%" align="center" style="color: Red; font-weight:bold;"><a href="/Discuz/User/StudentInfor/showAcademyFAC.jsp?school=<%=schoolNameString[j+1]%>"><%=schoolNameString[j+1]%></a></td>           
            <td width="33%" align="center" style="color: Red; font-weight:bold;"><a href="/Discuz/User/StudentInfor/showAcademyFAC.jsp?school=<%=schoolNameString[j+2]%>"><%=schoolNameString[j+2]%></a></td>
        </tr>
        <%
                            }
                            }
        ...
        <%
            ...
            <td width="33%" align="center" style="color: Red; font-weight:bold;"><a href="/Discuz/User/StudentInfor/showAcademyFAC.jsp?school=<%=schoolNameString[schoolNum-1]%>"><%=schoolNameString[schoolNum-1]%></a></td>
                    </tr>
                   <%
                            }
            ...
            <td width="33%" align="center" style="color: Red; font-weight:bold;"><img src="../../schoolPicture/<%=url[schoolNum-2]%>" width=117 height="141"></td>
             <td width="33%" align="center" style="color: Red; font-weight:bold;"><img src="../../schoolPicture/<%=url[schoolNum-1]%>" width=117 height="141"></td>
                      ...
                      <tr style="height: 28px" class="tdbg" align="center">
            <td width="33%" align="center" style="color: Red; font-weight:bold;"><a href="/Discuz/User/StudentInfor/showAcademyFAC.jsp?school=<%=schoolNameString[schoolNum-2]%>"><%=schoolNameString[schoolNum-2]%></a></td>
            <td width="33%" align="center" style="color: Red; font-weight:bold;"><a href="/Discuz/User/StudentInfor/showAcademyFAC.jsp?school=<%=schoolNameString[schoolNum-1]%>"><%=schoolNameString[schoolNum-1]%></a></td>
                    </tr>
