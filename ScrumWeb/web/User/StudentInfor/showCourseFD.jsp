<%-- 
    Document   : showCourseFD
    Created on : 2015-12-4, 21:12:41
    Author     : OovEver
--%>
...
<div class="cztable">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <%     // String userName=request.getParameter("name");                                  
           ...
           String url="";
           String commentEdit="/Discuz/MyInfo/commentEdit.jsp";
           String FileEdit="/Discuz/MyInfo/fileEdit.jsp";          
           String type=(String)session.getAttribute("choose");
