        ...
        <div class="bgh">
            <div class="page">
                ...
                <div class="topxx">
                    ...
                    910513201419学员：邹智，欢迎您！ <a href="../../MyInfo/Index.aspx.html">我的信息</a> <a href="systemMsge.aspx.html">
                        通知</a> <a href="../Account/ChangePasswd.aspx.html">密码修改</a> <a onclick="loginOut()"
...
<div class="cztable">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr style="height: 28px" class="tdbg" align="center">
            <td width="40%" align="center" style="color: Red; font-weight:bold;"><a href="/StudentManageSystem/User/StudentInfor/showHomeworkDetail.jsp?id=<%=pu.getId()%>"><%=pu.getTitle()%></a></td>
