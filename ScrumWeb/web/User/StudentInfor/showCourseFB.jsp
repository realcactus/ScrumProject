<%-- 
    Document   : showCourseFB
    Created on : 2015-12-7, 17:16:04
    Author     : OovEver
--%>
...
<div class="cztable">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <%     // String userName=request.getParameter("name");                                  
           ...
           String url="";
           String submitFile="/Discuz/User/StudentInfor/submitFile.jsp";
           String downloadFile="/Discuz/User/StudentInfor/downloadFile.jsp";
           String comment="/Discuz/User/StudentInfor/addComment.jsp";
           String creditAdd="/Discuz/MyInfo/addCredit.jsp";
           String type=(String)session.getAttribute("type");
           if(type.equals("question"))
           {
                url="/Discuz/MyInfo/commentFBEdit.jsp";    
               
           }else
           {
                url="/Discuz/MyInfo/fileFBEdit.jsp";    
           }
            ...
            int j=0;
            int rowNumI;
            schoolNum=CourseManagerDao.getInstance().selecCourseNum(schoolName,academy);
            if(schoolNum!=0){
            if(schoolNum!=0)
            {
            ...
            int []idI=new int[schoolNum];
             ...
             List<Course> list = CourseManagerDao.getInstance().selectEditCourseInfo(schoolName, academy);
                            if (list == null || list.size() < 1) {
                                out.println("没有数据");
                            } else {
                                for (Course pu : list) {
                             schoolNameString[i]=pu.getCourese();
                             idI[i]=pu.getId();
                              url2[i]=pu.getImg();
                             i++;                              
                                }
            ...
            <td width="33%" align="center" style="color: Red; font-weight:bold;"><img src="../../coursePicture/<%=url2[j]%>" width=117 height="141"></td>
            <td width="33%" align="center" style="color: Red; font-weight:bold;"><img src="../../coursePicture/<%=url2[j+1]%>" width=117 height="141"></td>           
            <td width="33%" align="center" style="color: Red; font-weight:bold;"><img src="../../coursePicture/<%=url2[j+2]%>" width=117 height="141"></td>
        </tr> 
      <tr style="height: 28px" class="tdbg" align="center">
        ...
        <%
                   ...
                   %>
                   <tr style="height: 28px" class="tdbg" align="center">
            <td width="33%" align="center" style="color: Red; font-weight:bold;"><img src="../../coursePicture/<%=url2[schoolNum-1]%>" width=117 height="141"></td>
            ...
            <td width="33%" align="center" style="color: Red; font-weight:bold;"><a href="<%=url%>?school=<%=schoolNameString[schoolNum-1]%>"><%=schoolNameString[schoolNum-1]%></a></td>
                   ...
                   %>
                     <tr style="height: 28px" class="tdbg" align="center">
            <td width="33%" align="center" style="color: Red; font-weight:bold;"><img src="../../coursePicture/<%=url2[schoolNum-2]%>" width=117 height="141"></td>
             <td width="33%" align="center" style="color: Red; font-weight:bold;"><img src="../../coursePicture/<%=url2[schoolNum-1]%>" width=117 height="141"></td>
        </tr>
                      <tr style="height: 28px" class="tdbg" align="center">
