<%-- 
    Document   : showSchoolFS
    Created on : 2015-12-6, 16:24:02
    Author     : OovEver
--%>
...
<div class="cztable">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <%     // String userName=request.getParameter("name");                                  
            ...
            int rowNumI;          
            String img="";
             List<smallMaster> list = smallMasterMgDao.getInstance().selectMasterInfo(username);
            ...
            <td width="33%" align="center" style="color: Red; font-weight:bold;"><img src="../../schoolPicture/<%=img%>" width=117 height="141"></td>
                      ...
                      <tr style="height: 28px" class="tdbg" align="center">
            <td width="33%" align="center" style="color: Red; font-weight:bold;"><a href="/Discuz/User/StudentInfor/showAcademyFS.jsp?school=<%=pu.getSchool()%>"><%=pu.getSchool()%></a></td>
