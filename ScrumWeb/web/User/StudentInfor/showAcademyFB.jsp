<%-- 
    Document   : showAcademyFB
    Created on : 2015-12-7, 16:24:50
    Author     : OovEver
--%>
...
<div class="cztable">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <%     // String userName=request.getParameter("name");                                  
           ...
           {
               url="/Discuz/MyInfo/courseEditFB.jsp";
           }else if(type.equals("add"))
           {
               url="/Discuz/User/Account/courseFBADD.jsp";
           }
           else if(type.equals("file"))
           {
               url="/Discuz/User/StudentInfor/showCourseFB.jsp";
           }
           else if(type.equals("mastermg"))
           {
                url="/Discuz/MyInfo/deleteFBSmallMaster.jsp";
           }
           else if(type.equals("masteradd"))
           {
               url="/Discuz/User/Account/addSmallMasterFB.jsp";
           }
           else
           {
               url="/Discuz/User/StudentInfor/showCourseFB.jsp";
