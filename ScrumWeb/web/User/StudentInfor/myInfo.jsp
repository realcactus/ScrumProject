            ...
            <div class="page">
                <div id="logo">
                 ...
                 <div class="topxx">
                   ...
                   <a href="/StudentManageSystem/MyInfo/PersonInfo.jsp">我的信息</a> <a href="/StudentManageSystem/User/StudentInfor/myInfo.jsp">
                        通知</a> <a href="/StudentManageSystem/User/Account/ChangePasswd.jsp">密码修改</a> <a
...
<div class="cztable">
    ...
    <%
       ...
       boolean flag = rs.absolute((curPage-1)*PAGESIZE+1);  
        String url="/StudentManageSystem/User/StudentInfor/myInfo.jsp";
        int count = 0;  
         do{  
