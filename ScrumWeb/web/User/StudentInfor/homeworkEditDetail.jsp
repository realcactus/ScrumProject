<%-- 
    Document   : homeworkEditDetail
    Created on : 2015-10-7, 10:18:07
    Author     : OovEver
--%>
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        ...
        int id;
            ...
            List<Homework> list = HomeworkDao.getInstance().selectHomeworkDtInfo(id);
                        ...
                        %>
                        <form action="../../editHomeworkServlet?id=<%=pu.getId()%>" method="post">
        <tr>
            <td width="15%" align="right"><div align="right">作业主题： </div></td>
            <td><input id="Ctitle" size="20" name="Ctitle" class="input_2" value="<%=pu.getTitle()%>"/></td>
        </tr>
    
        <tr>
            <td width="15%" align="right"><div align="right">作业内容： </div></td>
            <td><textarea name="Ccontent" cols="80" rows="5" id="Ccontent"class="input_2" ><%=pu.getContent()%></textarea></td>
        </tr>
        <tr>
