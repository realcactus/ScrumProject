<%-- 
    Document   : academyEditDetail
    Created on : 2015-12-2, 13:18:14
    Author     : OovEver
--%>
...
<div class="cztable">
     ...
     <%     // String userName=request.getParameter("name");                                  
            ...
            id=Integer.parseInt(idString);            
             List<Academy> list = academyManagerDao.getInstance().selectEditAcademyInfo(id);
                        ...
                        %>
 <form action="../../updateAcademyPicture" method="post" enctype="multipart/form-data">
 ...
 <table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">               
    <form action="../../academyEditServlet?id=<%=idString%>" method="post" >
     <tr align="center">
