<%-- 
    Document   : schoolAdd
    Created on : 2015-11-24, 21:32:38
    Author     : OovEver
--%>
...
<h2 class="mbx">论坛中心 &gt; 添加学校</h2>
<div class="cztable">
    <form action="../../upSchoolPicture" method="post" enctype="multipart/form-data">
	...
	<h1 class="title" align="center">添加学校</h1>
 	 ...
 	 <p class="blue">&nbsp;</p> 照片<%  String url="moren.jpg";
...
<table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
    ...
    <form action="../../schoolAddServlet" method="post">
     <tr align="center">
        ...
        <td style="width:70%; text-align:left;"><input id="studentID" name="schoolName" value="" type="text" class="input_2 txtinput1" /></td>
    </tr>

    <tr>
    <td colspan="2" style="text-align:center;"><input type="submit" id="btnSubmit" value="添加学校" class="input2" /></td>
    </tr>
     </form>
</table>
