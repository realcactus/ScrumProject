<%-- 
    Document   : courseFBADD
    Created on : 2015-12-7, 17:02:59
    Author     : OovEver
--%>
...
<div class="cztable">
     <form action="../../upCoursePictureFB" method="post" enctype="multipart/form-data">
...
<table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
    ...
    <form action="../../courseFBAddServlet" method="post">
           <tr align="center">
