<%-- 
    Document   : tgEditDetail
    Created on : 2015-10-7, 0:24:41
    Author     : OovEver
--%>
...
<table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
     <%     // String userName=request.getParameter("name");                                  
            ...
            id=Integer.parseInt(idString);            
             List<User> list = UserManagerDao.getInstance().selectEditTeacherInfo(id);
                        ...
                        %>
    <form action="../../tGEditServlet?id=<%=idString%>" method="post">
     <tr align="center">
