<%-- 
    Document   : schoolEditDetail
    Created on : 2015-11-25, 17:53:28
    Author     : OovEver
--%>
...
<div class="cztable">
     ...
     <%     // String userName=request.getParameter("name");                                  
            ...
            id=Integer.parseInt(idString);         
             ...
             List<School> list = SchoolManagerDao.getInstance().selectEditSchoolInfo(id);
                        ...
                        %>
                            <form action="../../updateSchoolPicture" method="post" enctype="multipart/form-data">
	<table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
	<tr>
	<td width="171">
	<h1 class="title" align="center">添加学校</h1>
	</td>
 	 ...
 	 <p class="blue">&nbsp;</p> 图片<%  
            ...
            %><%=url%> <img src="../../schoolPicture/<%=url%>" width=117 height="141">	
	 </td>
	 <tr>
	 <td width="171" align="center">   
      <div class="file-box" align="center"> 
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">                
    <form action="../../schoolEditServlet?id=<%=idString%>" method="post" >
     <tr align="center">
        <th style="width:20%; text-align:left;">校名：</th>
        <td style="width:70%; text-align:left;"><input id="studentID" name="schoolName" value="<%=pu.getSchool()%>" type="text" class="input_2 txtinput1" /></td>
    </tr>
   
    <tr>
    <td colspan="2" style="text-align:center;"><input type="submit" id="btnSubmit" value="更改学校信息" onclick="return changePassword()" class="input2" /></td>
    </tr>
     </form>
         <%
                                }
