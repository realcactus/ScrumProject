<%-- 
    Document   : creditAdd
    Created on : 2015-11-24, 15:23:04
    Author     : OovEver
--%>
...
<h2 class="mbx">论坛中心 &gt; 添加充值卡</h2>
<div class="cztable">
    
<table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
    <form action="../../creditAddServlet" method="post">
     <tr align="center">
        <th style="width:20%; text-align:left;">卡号：</th>
        <td style="width:70%; text-align:left;"><input id="studentID" name="creditName" value="" type="text" class="input_2 txtinput1" /></td>
    </tr>
    <tr align="center">
        <th style="width:20%; text-align:left;">积分：</th>
        <td style="width:70%; text-align:left;"><input id="studentName" name="credit"value="" type="text" class="input_2 txtinput1" /></td>
    </tr>  
        
   
    <tr>
    <td colspan="2" style="text-align:center;"><input type="submit" id="btnSubmit" value="添加充值卡" class="input2" /></td>
    </tr>
     </form>
</table>
