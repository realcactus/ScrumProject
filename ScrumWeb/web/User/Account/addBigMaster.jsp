<%-- 
    Document   : addBigMaster
    Created on : 2015-12-5, 15:23:11
    Author     : OovEver
--%>
...
<table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
        ...
        <td style="width:70%; text-align:center;">
            <select name="select" size="1">
                <%
                 int i=0;
            int sumI=0;
            List<bigMaster> list2=bigMasterMgDao.getInstance().selectMasterInfo();
             boolean flag=false;
                List<User> list=UserManagerDao.getInstance().selectMasterInfo();
    ...
    <tr>
    <td colspan="2" style="text-align:center;"><input type="submit" id="btnSubmit" value="添加大版主" class="input2" /></td>
    </tr>
     </form>
</table>
