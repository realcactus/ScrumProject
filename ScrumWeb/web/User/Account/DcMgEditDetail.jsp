<%-- 
    Document   : DcMgEditDetail
    Created on : 2015-11-24, 10:52:24
    Author     : OovEver
--%>
...
<table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
     <%     // String userName=request.getParameter("name");                                  
            ...
            id=Integer.parseInt(idString);            
             List<User> list = UserManagerDao.getInstance().selectEditDcMgInfo(id);
                        ...
                        %>
    <form action="../../DcMgEditServlet?id=<%=idString%>" method="post">    
     <tr align="center">
    ...
    <tr align="center">
        ...
        <td style="width:70%; text-align:left;"><input id="studentName" name="studentName" value="<%=pu.getNickName()%>" type="text" class="input_2 txtinput1" /></td>
    </tr>
    <tr align="center">
      ...
      <tr align="center">
        ...
        <td style="width:20%; text-align:left;"><input id="grade" name="credit" value="<%=pu.getCredit()%>" type="text" class="input_2 txtinput1" /></td>
    </tr>
              <tr align="center">
