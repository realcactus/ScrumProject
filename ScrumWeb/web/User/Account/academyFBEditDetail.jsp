<%-- 
    Document   : academyFBEditDetail
    Created on : 2015-12-7, 17:38:25
    Author     : OovEver
--%>
...
<div class="cztable">
     ...
     <%     // String userName=request.getParameter("name");                                  
            ...
            id=Integer.parseInt(idString);            
             List<Academy> list = academyManagerDao.getInstance().selectEditAcademyInfo(id);
                        ...
                        %>
      <form action="../../updateAcademyPictureFB" method="post" enctype="multipart/form-data">
                        <table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
	<tr>
	<td width="171">
	<h1 class="title" align="center">修改学院信息</h1>
	</td>
	 ...
	 <td width="171" align="center">   
      <div class="file-box" align="center"> 
        ...
        <input type="submit" value="提交" name="submit" size="20" class="button1"> 
         ...
         <table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
    <form action="../../academyFBEditServlet?id=<%=idString%>" method="post" >
     <tr align="center">
      ...
      <tr align="center">
        ...
        <td style="width:70%; text-align:left;"><input id="studentID" name="academyName" value="<%=pu.getAcademy()%>" type="text" class="input_2 txtinput1" /></td>
    </tr>
   
    <tr>
    <td colspan="2" style="text-align:center;"><input type="submit" id="btnSubmit" value="更改学院信息" onclick="return changePassword()" class="input2" /></td>
    </tr>
     </form>
         <%
                                }
