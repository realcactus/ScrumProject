<%-- 
    Document   : cardEditDetail
    Created on : 2015-11-24, 16:24:34
    Author     : OovEver
--%>

<%@page import="com.Discuz.Bean.Card"%>
<%@page import="java.util.List"%>
<%@page import="com.Discuz.DAO.CardManagerDao"%>
<%@page import="com.Discuz.DAO.CardManagerDao"%>
...
<table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
     <%     // String userName=request.getParameter("name");                                  
            ...
            id=Integer.parseInt(idString);            
             List<Card> list = CardManagerDao.getInstance().selectEditRootInfo(id);
    ...
    <form action="../../cardEditServlet?id=<%=idString%>" method="post" >
     <tr align="center">
        <th style="width:20%; text-align:left;">卡号：</th>
        <td style="width:70%; text-align:left;"><input id="studentID" name="cardName" value="<%=pu.getCardName()%>" type="text" class="input_2 txtinput1" /></td>
    </tr>
    <tr align="center">
        <th style="width:20%; text-align:left;">积分：</th>
        <td style="width:70%; text-align:left;"><input id="studentName" name="cardCredit" value="<%=pu.getCardcredit()%>" type="text" class="input_2 txtinput1" /></td>
    </tr>
   
    <tr>
    <td colspan="2" style="text-align:center;"><input type="submit" id="btnSubmit" value="更改充值卡信息" onclick="return changePassword()" class="input2" /></td>
    </tr>
     </form>
         <%
                                }
