<%-- 
    Document   : accademyFBadd
    Created on : 2015-12-7, 17:45:59
    Author     : OovEver
--%>
...
%>
    ...
    %>
<h2 class="mbx">个人中心 &gt;添加学院</h2>
<div class="cztable">
       <form action="../../upAcademyPictureFB" method="post" enctype="multipart/form-data">
...
<table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
    ...
    <form action="../../academyFBAddServlet?school=<%=school%>" method="post">
        <tr align="center">
