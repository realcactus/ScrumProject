        ...
        <div class="box mtop">
            <div class="leftbox">
                <div class="l_nav2">
                    ...
                    <div class="cdlist">
                        <div>
                            <a href="/Discuz/MyInfo/rootInfo.jsp">我的信息</a></div>
                        <div>
                            <a href="/Discuz/User/Account/rootAdd.jsp">添加人员 </a>
                        </div>
                        <div>
                            <a href="/Discuz/MyInfo/rootEdit.jsp">人员管理</a></div>
...
<div class="cztable">
    <table width="100%" cellpadding="0" cellspacing="0">
         <%     // String userName=request.getParameter("name");                                  
             int GroupNum=0;
             List<User> list = UserManagerDao.getInstance().selectEditRootInfo();
        ...
        <tr>
            <td colspan="2" align="center">
                <a href="../User/Account/rootEditDetail.jsp?id=<%=pu.getId()%>">编辑</a>
            
            </td>
              <td colspan="2" align="center">
                  <a href="../rootDeleteServlet?id=<%=pu.getId()%>">删除</a>
