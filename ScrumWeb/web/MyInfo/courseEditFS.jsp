<%-- 
    Document   : courseEditFS
    Created on : 2015-12-6, 17:59:13
    Author     : OovEver
--%>
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td colspan="2" align="center">
                <a href="../User/Account/courseFSEditDetail.jsp?id=<%=pu.getId()%>">编辑</a>
            
            </td>
              <td colspan="2" align="center">
                  <a href="../courseFSDeleteServlet?id=<%=pu.getId()%>">删除</a>
