<%-- 
    Document   : deleteFBSmallMaster
    Created on : 2015-12-7, 18:01:13
    Author     : OovEver
--%>
...
<div class="cztable">
    <table width="100%" cellpadding="0" cellspacing="0">
         <%     // String userName=request.getParameter("name");                                  
            ...
            if(academy==null)
            {
                academy=(String)session.getAttribute("school");
            }
            else
            {
            ...
            String school=(String)session.getAttribute("school");
             int GroupNum=0;
             List<smallMaster> list = smallMasterMgDao.getInstance().selectMasterInfo(school,academy);
                        ...
                        %>
        <tr>
            <td align="center" colspan="2" width="100">版主名：</td>
            <td colspan="2"><%=pu.getUserName()%></td>                
       
        </tr>          
        <tr>
     
              <td colspan="4" align="center">
                  <a href="../smallFBMasterDeleteServlet?id=<%=pu.getId()%>">删除</a>
