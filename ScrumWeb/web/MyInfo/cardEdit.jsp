<%-- 
    Document   : cardEdit
    Created on : 2015-11-24, 16:10:33
    Author     : OovEver
--%>
...
<h2 class="mbx">论坛中心 &gt; 充值卡管理</h2>       
<div class="cztable">
    <table width="100%" cellpadding="0" cellspacing="0">
         <%     // String userName=request.getParameter("name");                                  
             int GroupNum=0;
             List<Card> list = CardManagerDao.getInstance().selectEditCardInfo();
        ...
        <tr>
            ...
            <td><%=pu.getCardName()%></td>
            <td align="right" width="90">积分：</td>
            <td><%=pu.getCardcredit()%></td>           
        ...
        <tr>
            <td colspan="2" align="center">
                <a href="../User/Account/cardEditDetail.jsp?id=<%=pu.getId()%>">编辑</a>
            
            </td>
              <td colspan="2" align="center">
                  <a href="../cardDeleteServlet?id=<%=pu.getId()%>">删除</a>
