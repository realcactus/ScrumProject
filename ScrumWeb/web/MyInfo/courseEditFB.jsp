<%-- 
    Document   : courseEditFB
    Created on : 2015-12-7, 16:34:00
    Author     : OovEver
--%>
...
<div class="cztable">
    <table width="100%" cellpadding="0" cellspacing="0">
         <%     // String userName=request.getParameter("name");   
             ...
             int GroupNum=0;
             List<Course> list =CourseManagerDao.getInstance().selectEditCourseInfo(school, academy);
        ...
        <tr>
            <td colspan="2" align="center">
                <a href="../User/Account/courseFBEditDetail.jsp?id=<%=pu.getId()%>">编辑</a>
            
            </td>
              <td colspan="2" align="center">
                  <a href="../courseFBDeleteServlet?id=<%=pu.getId()%>">删除</a>
