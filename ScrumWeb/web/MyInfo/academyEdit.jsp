<%-- 
    Document   : academyEdit
    Created on : 2015-12-2, 11:34:09
    Author     : OovEver
--%>
...
<div class="cztable">
    <table width="100%" cellpadding="0" cellspacing="0">
         <%     // String userName=request.getParameter("name");                                  
             int GroupNum=0;
             List<Academy> list =academyManagerDao.getInstance().selectEditAcademyInfo();
        ...
        <tr>
            <td colspan="2" align="center">
                <a href="../User/Account/academyEditDetail.jsp?id=<%=pu.getId()%>">编辑</a>
            
            </td>
              <td colspan="2" align="center">
                  <a href="../academyDeleteServlet?id=<%=pu.getId()%>">删除</a>
