<%-- 
    Document   : schoolEdit
    Created on : 2015-11-24, 21:48:26
    Author     : OovEver
--%>
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
         <%     // String userName=request.getParameter("name");                                  
             ...
             List<School> list = SchoolManagerDao.getInstance().selectEditSchoolInfo();
                        ...
                        %>
        <tr>
            <td align="center" colspan="2" width="100">校名：</td>
            <td colspan="2"><%=pu.getSchool()%></td>                
       
        </tr>          
        <tr>
            <td colspan="2" align="center">
                <a href="../User/Account/schoolEditDetail.jsp?id=<%=pu.getId()%>">编辑</a>
            
            </td>
              <td colspan="2" align="center">
                  <a href="../schoolDeleteServlet?id=<%=pu.getId()%>">删除</a>
