...
<h2 class="mbx">教务中心 &gt;课程管理</h2>       
<div class="cztable">
    <table width="100%" cellpadding="0" cellspacing="0">
         <%     // String userName=request.getParameter("name");                                  
             int GroupNum=0;
             List<Course> list =CourseManagerDao.getInstance().selectEditCourseInfo();
        ...
        <tr>
            <td colspan="2" align="center">
                <a href="../User/Account/courseEditDetail.jsp?id=<%=pu.getId()%>">编辑</a>
            
            </td>
              <td colspan="2" align="center">
                  <a href="../courseDeleteServlet?id=<%=pu.getId()%>">删除</a>
