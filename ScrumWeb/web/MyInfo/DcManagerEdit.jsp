<%-- 
    Document   : DcManagerEdit
    Created on : 2015-11-24, 10:40:35
    Author     : OovEver
--%>
                    ...
                    <div class="cztable">
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <%     // String userName=request.getParameter("name");                                  
                                int GroupNum = 0;
                                List<User> list = UserManagerDao.getInstance().selectEditDcManageInfo();
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <a href="../User/Account/DcMgEditDetail.jsp?id=<%=pu.getId()%>">编辑</a>

                                </td>
                                <td colspan="2" align="center">
                                    <a href="../DcMgDeleteServlet?id=<%=pu.getId()%>">删除</a>
