            ...
            <div class="page">
                   ...
                   <div class="topxx">
                     ...
                     String username = (String) session.getAttribute("username");                                      
                                    if(username==null){    
                                        response.sendRedirect("/Discuz/User/StudentInfor/index.jsp?error=yes");
%>     
...
<div class="cztable">
   <table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
    ...
    <tr>
    <td colspan="2" style="text-align:center;"><input type="submit" id="btnSubmit" value="充值" class="input2" /></td>
    </tr>
     </form>
</table>
</div>
