<%-- 
    Document   : deleteBigMaster
    Created on : 2015-12-5, 18:46:48
    Author     : OovEver
--%>
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
         <%     // String userName=request.getParameter("name");                                  
            ...
            else
            {
             ...
             int GroupNum=0;
             List<bigMaster> list = bigMasterMgDao.getInstance().selectMasterInfo(school);
        ...
        <tr>
              ...
              <td colspan="4" align="center">
                  <a href="../bigMasterDeleteServlet?id=<%=pu.getId()%>">删除</a>
